												...
												<div class="panel-body">
													...
													<form role="form" name="adddoc" method="post" action="admin_validation.php" >
														<div class="form-group">
															...
															<input type="text" name="docname" class="form-control" value="" placeholder="Enter Doctor Name" required="true">
														</div>
														<div class="form-group">
															<label for="fess">
																 Doctor Email
														...
														<button type="submit" name="addocsubmit" id="submit" class="btn btn-o btn-primary">
															Submit
														</button>
													</form>
												</div>
