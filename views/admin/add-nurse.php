												...
												<div class="panel-body">
													...
													<form role="form" name="addnurs" method="post" action="admin_validation.php" >
														<div class="form-group">
															...
															<input type="text" name="nursename" class="form-control" value="" placeholder="Enter Nurse Name" required="true">
														</div>
														<div class="form-group">
															<label for="fess">
																 Nurse Email
														...
														<button type="submit" name="addnursubmit" id="submit" class="btn btn-o btn-primary">
															Submit
														</button>
													</form>
												</div>
