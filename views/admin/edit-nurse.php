											...
											<div class="panel panel-white">
												...
												<div class="panel-body">
													<?php 
														...
														//write query string
														$selQuery = "SELECT * FROM staff WHERE type='Nurse' AND StaffID = '$did'";
													...
													<hr />
													<form role="form" name="addnurs" method="post" action="admin_validation.php">
														...
														<div class="form-group">
															<label for="nurspassword">
																 Password
															</label>
															<input type="text" name="npass" class="form-control" value="<?php echo htmlentities($data['Password']);?>" >
														</div>
														<?php } ?>
														
														<button type="submit" name="editnursubmit" class="btn btn-o btn-primary">
															Update
														</button>
													</form>
												</div>
