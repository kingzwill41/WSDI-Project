<?php
  ...
  check_login();
  $_SESSION['idk'] = $vid=intval($_GET['id']);// get doctor id
        ...
        <div class="container-fluid container-fullw bg-white">
          <div class="row">
            <div class="col-md-12">
              ...
              <?php  
                $ret=mysqli_query($conn,"SELECT * FROM medicalhistory where TRN='$vid'");
              ?>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <table class="table table-bordered table-hover data-tables">
                        <form method="post" name="submit" action="doc_validation.php">
                          <tr>
                            <th>Blood Pressure :</th>
                            <td>
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="submit" name="addmedsubmit" class="btn btn-primary">Submit</button>
